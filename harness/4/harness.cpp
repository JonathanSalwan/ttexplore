...
int main(int ac, const char *av[]) {
  ...
  ctx.setConcreteMemoryValue(triton::arch::MemoryAccess(0x4018, triton::size::qword), base_libc + triton::stubs::x8664::systemv::libc::symbols.at("strncasecmp"));
  ...
  ctx.setConcreteRegisterValue(ctx.registers.x86_rsi, 100);
